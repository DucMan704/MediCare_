  ...
  return (
    <div className="flex justify-center">
      <div className="w-full max-w-xl">
        ...
        >
          {hasDiabetes
            ? "Bạn có nguy cơ mắc tiểu đường. Vui lòng tham khảo ý kiến bác sĩ."
            : "Bạn không có dấu hiệu tiểu đường theo kết quả dự đoán."}
        </div>
