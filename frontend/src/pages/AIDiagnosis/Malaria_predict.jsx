  ...
  return (
    <div className="flex justify-center" style={{ marginBottom: "477px" }}>
      <div className="w-full max-w-xl">
        ...
        >
          {isInfected
            ? "Tế bào này bị nhiễm sốt rét."
            : "Tế bào này không bị nhiễm sốt rét."}
        </div>
